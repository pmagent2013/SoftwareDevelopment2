...
<p>You can change the status of items from this page </p>
...
# Show the records
show_recordsFoundRecentAdmin($dbc, $days);
...
if ($_SERVER[ 'REQUEST_METHOD' ] == 'POST') {
    ...
    update_FoundItem($dbc, $id, $currentStatus);

}

?>
<form action="modifyFound.php" method="POST">
<table>
<tr>
